...
import { HistoricoLegajoMovimientoComponent } from './historico-legajo-movimiento/historico-legajo-movimiento.component';

@Component({
  selector: 'app-historicos-legajos-movimientos',
  templateUrl: './historicos-legajos-movimientos.component.html',
  styleUrls: ['./historicos-legajos-movimientos.component.scss']
})
export class HistoricosLegajosMovimientosComponent extends BaseCrudComponent implements OnInit {
  ...
  constructor( private dialog: MatDialog, 
    ...
    this.breadcrumb = [{label: 'Consultas'}, {label:'Historicos Legajos Movimientos', url:'/home/consultas/historico_legajos'}];
  }
  ...
  public openDialog(row?: any, viewing?: boolean): void {
    ...
    const dialogRef = this.dialog.open(HistoricoLegajoMovimientoComponent, dialogConfig);
  ...
  protected getFunctionId(): string {
    return "ecd.historico_legajos";
  }

  protected getCrudName(): string {
    return "historiaLegajoMovimiento";
  }
