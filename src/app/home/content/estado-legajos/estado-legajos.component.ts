...
import { EstadoLegajoComponent } from './estado-legajo/estado-legajo-dialog.component';

@Component({
  selector: 'app-estado-legajos',
  templateUrl: './estado-legajos.component.html',
  styleUrls: ['./estado-legajos.component.scss']
})
export class EstadoLegajosComponent  extends BaseCrudComponent implements OnInit{
  ...
  constructor( private dialog: MatDialog, protected override alertService: AlertService, protected override restService: RestService,  protected override router: Router, protected override tableService: TableService) {
    ...
    this.breadcrumb = [{label: 'Datos Comunes'}, {label:'Estado de Legajos', url:'/home/datos_comunes/estado_legajo'}];
  }
  ...
  public openDialog(row?: any, viewing?: boolean): void {
    ...
    const dialogRef = this.dialog.open(EstadoLegajoComponent, dialogConfig);
